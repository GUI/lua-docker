...
- `5-oracular`, `5.4-oracular`, `5.4.8-oracular`: [lua-5.4/oracular/Dockerfile](https://github.com/GUI/lua-docker/blob/main/lua-5.4/oracular/Dockerfile)
...
- `5-luarocks-oracular`, `5.4-luarocks-oracular`, `5.4.8-luarocks-oracular`: [lua-5.4/luarocks-oracular/Dockerfile](https://github.com/GUI/lua-docker/blob/main/lua-5.4/luarocks-oracular/Dockerfile)
