...
- `5-alpine`, `5-alpine3.12`, `5.4-alpine`, `5.4-alpine3.12`, `5.4.2-alpine`, `5.4.2-alpine3.12`, `alpine`: [lua-5.4/alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/alpine3.12/Dockerfile)
- `5-alpine3.11`, `5.4-alpine3.11`, `5.4.2-alpine3.11`: [lua-5.4/alpine3.11/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/alpine3.11/Dockerfile)
- `5-alpine3.10`, `5.4-alpine3.10`, `5.4.2-alpine3.10`: [lua-5.4/alpine3.10/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/alpine3.10/Dockerfile)
...
- `5-luarocks-alpine`, `5-luarocks-alpine3.12`, `5.4-luarocks-alpine`, `5.4-luarocks-alpine3.12`, `5.4.2-luarocks-alpine`, `5.4.2-luarocks-alpine3.12`, `luarocks-alpine`: [lua-5.4/luarocks-alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-alpine3.12/Dockerfile)
- `5-luarocks-alpine3.11`, `5.4-luarocks-alpine3.11`, `5.4.2-luarocks-alpine3.11`: [lua-5.4/luarocks-alpine3.11/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-alpine3.11/Dockerfile)
- `5-luarocks-alpine3.10`, `5.4-luarocks-alpine3.10`, `5.4.2-luarocks-alpine3.10`: [lua-5.4/luarocks-alpine3.10/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-alpine3.10/Dockerfile)
...
- `5-focal`, `5-ubuntu`, `5.4-focal`, `5.4-ubuntu`, `5.4.2-focal`, `5.4.2-ubuntu`, `ubuntu`: [lua-5.4/focal/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/focal/Dockerfile)
- `5-bionic`, `5.4-bionic`, `5.4.2-bionic`: [lua-5.4/bionic/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/bionic/Dockerfile)
...
- `5-luarocks-focal`, `5-luarocks-ubuntu`, `5.4-luarocks-focal`, `5.4-luarocks-ubuntu`, `5.4.2-luarocks-focal`, `5.4.2-luarocks-ubuntu`, `luarocks-ubuntu`: [lua-5.4/luarocks-focal/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-focal/Dockerfile)
- `5-luarocks-bionic`, `5.4-luarocks-bionic`, `5.4.2-luarocks-bionic`: [lua-5.4/luarocks-bionic/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-bionic/Dockerfile)
...
- `5-centos`, `5-centos8`, `5.4-centos`, `5.4-centos8`, `5.4.2-centos`, `5.4.2-centos8`, `centos`: [lua-5.4/centos8/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/centos8/Dockerfile)
- `5-centos7`, `5.4-centos7`, `5.4.2-centos7`: [lua-5.4/centos7/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/centos7/Dockerfile)
- `5-luarocks-centos`, `5-luarocks-centos8`, `5.4-luarocks-centos`, `5.4-luarocks-centos8`, `5.4.2-luarocks-centos`, `5.4.2-luarocks-centos8`, `luarocks-centos`: [lua-5.4/luarocks-centos8/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-centos8/Dockerfile)
- `5-luarocks-centos7`, `5.4-luarocks-centos7`, `5.4.2-luarocks-centos7`: [lua-5.4/luarocks-centos7/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-centos7/Dockerfile)
