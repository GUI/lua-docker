...
- `5-alpine`, `5-alpine3.14`, `5.4-alpine`, `5.4-alpine3.14`, `5.4.3-alpine`, `5.4.3-alpine3.14`, `alpine`: [lua-5.4/alpine3.14/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/alpine3.14/Dockerfile)
- `5-alpine3.12`, `5.4-alpine3.12`, `5.4.3-alpine3.12`: [lua-5.4/alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/alpine3.12/Dockerfile)
...
- `5-luarocks-alpine`, `5-luarocks-alpine3.14`, `5.4-luarocks-alpine`, `5.4-luarocks-alpine3.14`, `5.4.3-luarocks-alpine`, `5.4.3-luarocks-alpine3.14`, `luarocks-alpine`: [lua-5.4/luarocks-alpine3.14/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-alpine3.14/Dockerfile)
- `5-luarocks-alpine3.12`, `5.4-luarocks-alpine3.12`, `5.4.3-luarocks-alpine3.12`: [lua-5.4/luarocks-alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-alpine3.12/Dockerfile)
...
- `5.3-alpine`, `5.3-alpine3.14`, `5.3.6-alpine`, `5.3.6-alpine3.14`: [lua-5.3/alpine3.14/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.3/alpine3.14/Dockerfile)
- `5.3-alpine3.12`, `5.3.6-alpine3.12`: [lua-5.3/alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.3/alpine3.12/Dockerfile)
...
- `5.3-luarocks-alpine`, `5.3-luarocks-alpine3.14`, `5.3.6-luarocks-alpine`, `5.3.6-luarocks-alpine3.14`: [lua-5.3/luarocks-alpine3.14/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.3/luarocks-alpine3.14/Dockerfile)
- `5.3-luarocks-alpine3.12`, `5.3.6-luarocks-alpine3.12`: [lua-5.3/luarocks-alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.3/luarocks-alpine3.12/Dockerfile)
...
- `5.2-alpine`, `5.2-alpine3.14`, `5.2.4-alpine`, `5.2.4-alpine3.14`: [lua-5.2/alpine3.14/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.2/alpine3.14/Dockerfile)
- `5.2-alpine3.12`, `5.2.4-alpine3.12`: [lua-5.2/alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.2/alpine3.12/Dockerfile)
...
- `5.2-luarocks-alpine`, `5.2-luarocks-alpine3.14`, `5.2.4-luarocks-alpine`, `5.2.4-luarocks-alpine3.14`: [lua-5.2/luarocks-alpine3.14/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.2/luarocks-alpine3.14/Dockerfile)
- `5.2-luarocks-alpine3.12`, `5.2.4-luarocks-alpine3.12`: [lua-5.2/luarocks-alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.2/luarocks-alpine3.12/Dockerfile)
...
- `5.1-alpine`, `5.1-alpine3.14`, `5.1.5-alpine`, `5.1.5-alpine3.14`: [lua-5.1/alpine3.14/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.1/alpine3.14/Dockerfile)
- `5.1-alpine3.12`, `5.1.5-alpine3.12`: [lua-5.1/alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.1/alpine3.12/Dockerfile)
...
- `5.1-luarocks-alpine`, `5.1-luarocks-alpine3.14`, `5.1.5-luarocks-alpine`, `5.1.5-luarocks-alpine3.14`: [lua-5.1/luarocks-alpine3.14/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.1/luarocks-alpine3.14/Dockerfile)
- `5.1-luarocks-alpine3.12`, `5.1.5-luarocks-alpine3.12`: [lua-5.1/luarocks-alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.1/luarocks-alpine3.12/Dockerfile)
...
- `5.0-alpine`, `5.0-alpine3.14`, `5.0.3-alpine`, `5.0.3-alpine3.14`: [lua-5.0/alpine3.14/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.0/alpine3.14/Dockerfile)
- `5.0-alpine3.12`, `5.0.3-alpine3.12`: [lua-5.0/alpine3.12/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.0/alpine3.12/Dockerfile)
