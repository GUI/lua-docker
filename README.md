...
- `5`, `5-buster`, `5.4`, `5.4-buster`, `5.4.2`, `5.4.2-buster`, `latest`: [lua-5.4/buster/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/buster/Dockerfile)
- `5-stretch`, `5.4-stretch`, `5.4.2-stretch`: [lua-5.4/stretch/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/stretch/Dockerfile)
- `5-jessie`, `5.4-jessie`, `5.4.2-jessie`: [lua-5.4/jessie/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/jessie/Dockerfile)
- `5-luarocks`, `5-luarocks-buster`, `5.4-luarocks`, `5.4-luarocks-buster`, `5.4.2-luarocks`, `5.4.2-luarocks-buster`, `luarocks`: [lua-5.4/luarocks-buster/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-buster/Dockerfile)
- `5-luarocks-stretch`, `5.4-luarocks-stretch`, `5.4.2-luarocks-stretch`: [lua-5.4/luarocks-stretch/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-stretch/Dockerfile)
- `5-luarocks-jessie`, `5.4-luarocks-jessie`, `5.4.2-luarocks-jessie`: [lua-5.4/luarocks-jessie/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-jessie/Dockerfile)
- `5-alpine`, `5-alpine3.10`, `5.4-alpine`, `5.4-alpine3.10`, `5.4.2-alpine`, `5.4.2-alpine3.10`, `alpine`: [lua-5.4/alpine3.10/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/alpine3.10/Dockerfile)
- `5-alpine3.9`, `5.4-alpine3.9`, `5.4.2-alpine3.9`: [lua-5.4/alpine3.9/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/alpine3.9/Dockerfile)
- `5-luarocks-alpine`, `5-luarocks-alpine3.10`, `5.4-luarocks-alpine`, `5.4-luarocks-alpine3.10`, `5.4.2-luarocks-alpine`, `5.4.2-luarocks-alpine3.10`, `luarocks-alpine`: [lua-5.4/luarocks-alpine3.10/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-alpine3.10/Dockerfile)
- `5-luarocks-alpine3.9`, `5.4-luarocks-alpine3.9`, `5.4.2-luarocks-alpine3.9`: [lua-5.4/luarocks-alpine3.9/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-alpine3.9/Dockerfile)
- `5-bionic`, `5-ubuntu`, `5.4-bionic`, `5.4-ubuntu`, `5.4.2-bionic`, `5.4.2-ubuntu`, `ubuntu`: [lua-5.4/bionic/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/bionic/Dockerfile)
- `5-xenial`, `5.4-xenial`, `5.4.2-xenial`: [lua-5.4/xenial/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/xenial/Dockerfile)
- `5-luarocks-bionic`, `5-luarocks-ubuntu`, `5.4-luarocks-bionic`, `5.4-luarocks-ubuntu`, `5.4.2-luarocks-bionic`, `5.4.2-luarocks-ubuntu`, `luarocks-ubuntu`: [lua-5.4/luarocks-bionic/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-bionic/Dockerfile)
- `5-luarocks-xenial`, `5.4-luarocks-xenial`, `5.4.2-luarocks-xenial`: [lua-5.4/luarocks-xenial/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-xenial/Dockerfile)
- `5-centos`, `5-centos7`, `5.4-centos`, `5.4-centos7`, `5.4.2-centos`, `5.4.2-centos7`, `centos`: [lua-5.4/centos7/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/centos7/Dockerfile)
- `5-centos6`, `5.4-centos6`, `5.4.2-centos6`: [lua-5.4/centos6/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/centos6/Dockerfile)
- `5-luarocks-centos`, `5-luarocks-centos7`, `5.4-luarocks-centos`, `5.4-luarocks-centos7`, `5.4.2-luarocks-centos`, `5.4.2-luarocks-centos7`, `luarocks-centos`: [lua-5.4/luarocks-centos7/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-centos7/Dockerfile)
- `5-luarocks-centos6`, `5.4-luarocks-centos6`, `5.4.2-luarocks-centos6`: [lua-5.4/luarocks-centos6/Dockerfile](https://github.com/GUI/lua-docker/blob/master/lua-5.4/luarocks-centos6/Dockerfile)
