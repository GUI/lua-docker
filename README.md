...
- `2-jammy`, `2.1-jammy`, `2.1.1727870382-jammy`: [luajit-2.1/jammy/Dockerfile](https://github.com/GUI/lua-docker/blob/main/luajit-2.1/jammy/Dockerfile)
...
- `2-luarocks-jammy`, `2.1-luarocks-jammy`, `2.1.1727870382-luarocks-jammy`: [luajit-2.1/luarocks-jammy/Dockerfile](https://github.com/GUI/lua-docker/blob/main/luajit-2.1/luarocks-jammy/Dockerfile)
...
- `2-lua52compat-jammy`, `2.1-lua52compat-jammy`, `2.1.1727870382-lua52compat-jammy`: [luajit-2.1/lua52compat-jammy/Dockerfile](https://github.com/GUI/lua-docker/blob/main/luajit-2.1/lua52compat-jammy/Dockerfile)
...
- `2-lua52compat-luarocks-jammy`, `2.1-lua52compat-luarocks-jammy`, `2.1.1727870382-lua52compat-luarocks-jammy`: [luajit-2.1/lua52compat-luarocks-jammy/Dockerfile](https://github.com/GUI/lua-docker/blob/main/luajit-2.1/lua52compat-luarocks-jammy/Dockerfile)
